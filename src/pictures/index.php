...
<!--            <li><a href="../#Transport">Transport</a></li> -->
    ...
    <div class="container">
      <div id="coloradoPics" class="inner jumptarget">
        <h3>Colorado Pictures</h3>
        The following pictures were taken in Rocky Mountain National Park where Sydnee and Eric were engaged. Though there were no pictures taken at the time of the engagement due to dead phones and cameras (from the previous days camping), we did capture some great moments the following Spring! Sydnee, Eric, and his family returned to the site of the engagement and his brothers (and groomsmen) Thor and SeanPaul helped recreate and shoot photos of the engagement which can be seen below.
        <br><br>
      ...
      <div id="austinPics" class="inner jumptarget">
        ...
        <div class="col-lg-6 col-lg-offset-3">
          <div class="carousel slide" id="austinCarousel" style="width: 400px; margin 0 auto">
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-md-4"><a href="#"><img src="http://i.imgur.com/YQ7QFOO.jpg" class="img-responsive" title="The bridge where Eric proposed to Sydnee"></a></div>
              </div>
              <div class="item">
